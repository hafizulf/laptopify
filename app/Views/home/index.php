        ...
        <div class="card-body badge-primary">
          ...
          <ol class="text-putih">
            ...
            <li>Proses Perhitungan
              <p class="mb-0">
                - Jika nilai kriteria sudah ditentukan, selanjutnya tentukan nilai utility pada halaman informasi<a href="/perhitungan/nilai-kriteria" target="_blank"> Nilai Kriteria</a> dengan meng-klik <button type="button" class="btn btn-sm btn-dark"><i class="fas fa fa-recycle"></i> Tentukan Nilai Utility</button>
              </p>
              <p class="mb-0">
                - Selanjutnya, pada halaman informasi <a href="/perhitungan/nilai-utility" target="_blank">Nilai Utility</a> tentukan nilai akhir dengan meng-klik <button type="button" class="btn btn-sm btn-dark"><i class="fas fa fa-recycle"></i> Tentukan Nilai Akhir</button>
              </p>
              <p>
