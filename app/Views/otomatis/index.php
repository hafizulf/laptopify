        ...
        <div class="card-body">
          <form action="/otomatis/get-data" method="GET">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="min_price" id="min_price" placeholder="Harga minimum...">
            </div>
            <div class="form-group">
              <label for="max_price">Harga Maksimum</label>
              <input type="number" class="form-control" name="max_price" id="max_price" placeholder="Harga maksimum...">
            </div>
            <div class="form-group">
              <label for="limit">Limit <small class="text-sm badge badge-primary">default 20</small></label>
              <input type="number" class="form-control" name="limit" id="limit" placeholder="Limit Data" min="1" max="100">
            </div>
