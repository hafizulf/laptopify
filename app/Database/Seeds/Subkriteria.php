...
class Subkriteria extends Seeder
{
  public function run()
  {
    $data = [
      ...
      ['kriteria_id' => 9, 'nama' => 'Intel HD Graphics', 'nilai_preferensi' => 5],
      ['kriteria_id' => 9, 'nama' => 'AMD Radeon Graphics', 'nilai_preferensi' => 3],
      ['kriteria_id' => 9, 'nama' => 'Lain', 'nilai_preferensi' => 1],
      ['kriteria_id' => 10, 'nama' => 'Windows 11', 'nilai_preferensi' => 5],
      ['kriteria_id' => 10, 'nama' => 'Windows 10', 'nilai_preferensi' => 3],
      ['kriteria_id' => 10, 'nama' => 'Lain', 'nilai_preferensi' => 1],
