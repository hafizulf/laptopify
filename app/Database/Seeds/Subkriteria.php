...
class Subkriteria extends Seeder
{
  public function run()
  {
    $data = [
      ...
      ['kriteria_id' => 6, 'nama' => 'SSD', 'nilai_preferensi' => 3],
      ...
      ['kriteria_id' => 9, 'nama' => 'Intel', 'nilai_preferensi' => 3],
      ['kriteria_id' => 9, 'nama' => 'Nvidia', 'nilai_preferensi' => 1],
      ['kriteria_id' => 10, 'nama' => 'Windows', 'nilai_preferensi' => 3],
